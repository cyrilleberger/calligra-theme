...
function fix_main_menu_class($classes, $item) {
  if($item->title == "Learn more") {
    if(has_ancestor("words") or has_ancestor("sheets") or has_ancestor("stage") or has_ancestor("kexi") or has_ancestor("plan") or has_ancestor("flow") or has_ancestor("krita") or has_ancestor("karbon") or has_ancestor("gemini") or has_ancestor("author") ) {
