...
function twentyten_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-author vcard">
			...
			<?php printf( __( '%s <span class="says">says:</span>', 'twentyten' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author() ) ); ?>
...
function fix_main_menu_class($classes, $item) {
  if($item->title == "Learn more") {
    if(has_ancestor("words") or has_ancestor("sheets") or has_ancestor("stage") or has_ancestor("kexi") or has_ancestor("plan") or has_ancestor("flow") or has_ancestor("krita") or has_ancestor("karbon") or has_ancestor("calligra-gemini") or has_ancestor("author") ) {
